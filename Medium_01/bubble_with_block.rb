...
# Further Exploration - Modify your solution so it only passes one element to the block at a time; the block should perform some sort of transformation to the argument, and #bubble_sort! itself should just use <= to compare two values. In other words, you should be able to call #bubble_sort! like this:
...
array = %w(sue Pete alice Tyler rachel Kim bonnie)
bubble_sorter!(array) { |value| value.downcase }
puts array == %w(alice bonnie Kim Pete rachel sue Tyler)